...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div id="success-message" class="alert alert-success hidden">
                ...
                <button id="close-success" class="close">&times;</button>
            </div>
            @endif
            @yield('content')
        </div>
    ...
    <script>
        ...
        function showSuccessMessage(message) {
            ...
            // Automatically hide the message after a short delay (e.g., 5 seconds)
            setTimeout(function () {
                hideSuccessMessage();
            }, 5000);
        }
        ...
        // Event listener to close the message when the close button is clicked
